...
#if defined(NDEBUG)
# error "PagareX cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "PagareX Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    {
        nSubsidy = 10500000 * COIN;   //10.5M Premine for ICO
    }
        else
...
int64_t GetProofOfStakeReward(int nHeight, int64_t nCoinAge, int64_t nFees)
{
    ...
    else if(pindexBest->nHeight < 105121)
    	nRewardCoinYear = 96 * COIN_YEAR_REWARD; //90%
    else if(pindexBest->nHeight < 157682)
    	nRewardCoinYear = 84 * COIN_YEAR_REWARD; //84%
	else if(pindexBest->nHeight < 210243)
    	nRewardCoinYear = 60 * COIN_YEAR_REWARD; //60%
    else if(pindexBest->nHeight < 262804)
...
#ifdef ENABLE_WALLET
// pagarex: attempt to generate suitable proof-of-stake
