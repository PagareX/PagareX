...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\PagareX
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\PagareX
    // Mac: ~/Library/Application Support/PagareX
    // Unix: ~/.pagarex
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "PagareX";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "pagarex.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "pagarexd.pid"));
