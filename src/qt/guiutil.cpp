...
{
    // Convert pagarex:// to pagarex:
    //
    //    Cannot handle this later, because bitcoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("pagarex://"))
    {
        uri.replace(0, 12, "pagarex:");
    }
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "PagareX.lnk";
}
...
{
    return GetAutostartDir() / "pagarex.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("PagareX-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  pagarex-qt [" + tr("command-line options") + "]                     " + "\n";
...
void SetBlackThemeQSS(QApplication& app)
{
    app.setStyleSheet("QWidget        { background: rgb(41,44,48); }"
                      ...
                      "QPushButton    { background: rgb(31,127,232); color: rgb(21,21,21); }"
                      ...
                      "QToolButton:checked { color: rgb(255,255,255); border: none; border-left-color: rgb(31,127,232); border-left-style: solid; border-left-width: 6px; }"
