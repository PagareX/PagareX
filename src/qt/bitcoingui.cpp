    ...
    nWeight(0)
{
    //resize(900, 520);
	resize(1080, 662);
    setWindowTitle(tr("PagareX") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/pagarex"));
    setWindowIcon(QIcon(":icons/pagarex"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a PagareX address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/pagarex"), tr("&About PagareX"), this);
    aboutAction->setToolTip(tr("Show information about PagareX"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for PagareX"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/pagarex"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/pagarex_testnet"));
            setWindowIcon(QIcon(":icons/pagarex_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/pagarex_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("PagareX client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("PagareX client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to PagareX network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid PagareX address or malformed URI parameters."));
    }
